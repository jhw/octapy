...
class MidiPartTrack(BasePartTrack):
    ...
    def lfo_speed1(self) -> int:
        """Get/set LFO 1 speed (0-127)."""
        return self._data[self._values_offset() + MidiTrackValuesOffset.LFO_SPD1]

    @lfo_speed1.setter
    def lfo_speed1(self, value: int):
        self._data[self._values_offset() + MidiTrackValuesOffset.LFO_SPD1] = value & 0x7F

    @property
    def lfo_speed2(self) -> int:
        """Get/set LFO 2 speed (0-127)."""
        return self._data[self._values_offset() + MidiTrackValuesOffset.LFO_SPD2]

    @lfo_speed2.setter
    def lfo_speed2(self, value: int):
        self._data[self._values_offset() + MidiTrackValuesOffset.LFO_SPD2] = value & 0x7F

    @property
    def lfo_speed3(self) -> int:
        """Get/set LFO 3 speed (0-127)."""
        return self._data[self._values_offset() + MidiTrackValuesOffset.LFO_SPD3]

    @lfo_speed3.setter
    def lfo_speed3(self, value: int):
        self._data[self._values_offset() + MidiTrackValuesOffset.LFO_SPD3] = value & 0x7F

    @property
    def lfo_depth1(self) -> int:
        """Get/set LFO 1 depth (0-127)."""
        return self._data[self._values_offset() + MidiTrackValuesOffset.LFO_DEP1]

    @lfo_depth1.setter
    def lfo_depth1(self, value: int):
        self._data[self._values_offset() + MidiTrackValuesOffset.LFO_DEP1] = value & 0x7F

    @property
    def lfo_depth2(self) -> int:
        """Get/set LFO 2 depth (0-127)."""
        return self._data[self._values_offset() + MidiTrackValuesOffset.LFO_DEP2]

    @lfo_depth2.setter
    def lfo_depth2(self, value: int):
        self._data[self._values_offset() + MidiTrackValuesOffset.LFO_DEP2] = value & 0x7F

    @property
    def lfo_depth3(self) -> int:
        """Get/set LFO 3 depth (0-127)."""
        return self._data[self._values_offset() + MidiTrackValuesOffset.LFO_DEP3]

    @lfo_depth3.setter
    def lfo_depth3(self, value: int):
        self._data[self._values_offset() + MidiTrackValuesOffset.LFO_DEP3] = value & 0x7F
